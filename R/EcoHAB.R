...
EcoHAB <- R6::R6Class("EcoHAB",
                      private = list(
                        ...
                        # Convert a serial RFID reads into events of which two consequetive reads serve as start and end.
                        raw_events = function(sub_dt) {
                          dup_dt <- sub_dt
                          # add a vitual rfid read to make the first event before the mouse is detected for the first time
                          # the virtual read is loc_threshold ahead of the first read so that the first event is not deemed at any RFID reader
                          ...
                          # among them make the first event as combined and delete the others 
                        ...
                        # Suggest a most likely location of the mouse based on the start and end RFID reads.
                        ...
                        # Combine any overlapping time intervals within dt
                        ...
                        # Remove from x any time intervals overlapping with y 
                      ...
                      public = list(
                        ...
                        initialize = function(raw_files = NULL, idfile = NULL,
                          ...
                          # if there is only 1 ambiguous time stamp, it will be deemed as DST
                          # if there are multiple ambiguous, each will be deemed as DST until reaching a rollback
                          # after the rollback each will be deemed as non-DST
                        ...
                        #' @param threshold The maximal interval bewtween two animals in the "delayed" mode
                        #' @return The current EcoHAB object
